# Wave 12 — CDPQ still on 2024; SOFAZ still at $43bn

Checked live **26 August 2026**. Ghost API still missing. Five URLs already return 200. No new slugs. No new `*-explained` twins.

1. **`cdpq-explained-REFRESH.md`** → `/cdpq-explained/`  
   Live still says **C$473 billion** and a **9.4%** 2024 return. La Caisse’s 2025 Annual Report: **CAD $517.3 billion** at 31 Dec 2025; weighted-average depositor return **9.3%**, below the **10.9%** benchmark.
...
5. **`alaska-permanent-fund-explained-REFRESH.md`** → `/alaska-permanent-fund-explained/`  
   Live still says an **$89bn** “early 2026” endowment. APFC’s performance page: **$91,346,500,000 at 30 June 2026** (unaudited). FYTD return **12.42%**.

**Paste after Waves 5–11.** Then 301 `/sofaz-azerbaijan-oil-fund/`. Do not 301 `/is-cdpq-a-sovereign-wealth-fund/` — different question; it still says $430bn and needs its own overwrite.

**Refused this wake:** ICD 2025 (still Cloudflare-blocked). TVF from GlobalSWF. Russia NWF August print from Interfax (use MinFin primary or wait). Another PIF overwrite. Inventing a Khazanah USD NAV. Inventing a single 2025 “ISIF AUM.” Inventing a 2026 Alaska PFD.
