...
Wave 1–4 slugs that 404 will sit in that 4xx bucket until Ghost publish. Rechecked 26 Aug wake 28: `/directory/` still 404. Waves 5–28 keepers still return 200 with pre-refresh copy (GPIF live return still 15.83%; CIC explained still $1.3T; SWF vs reserves still $15T / invented ADSWF; Gulf PE still $200bn deploy / PIF–KKR $40bn; country list still $10.7T). No newer Search Impact mail than 700 clicks / 28 days to 18 Aug. Newest named Ghost signup: Brett Morgan (26 Aug 12:24 UTC). MailAdx still mailing wallet $0.00.
