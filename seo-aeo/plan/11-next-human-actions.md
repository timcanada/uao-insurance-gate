...
3. If Ghost API is not in yet, paste in this order: **Wave 5** SWF keeper → 301 twins → **Wave 6** asset-owners (drop 2025 title) → **Wave 7** (`/public-pension-funds/`, `/gpif-japan-explained/` — live FY return is **wrong**, `/norges-bank-investment-management-nbim/`) → Wave 4 GSC winners → Wave 3 defines → Wave 1–2 new slugs. Prefer the API.
