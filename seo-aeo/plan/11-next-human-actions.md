...
Once those secrets are in, this agent publishes Wave 1–16 as Ghost drafts (or live if you say so) and scores the keyword board from GSC instead of “unknown.”
...
3. If Ghost API is not in yet, paste in this order: **Wave 5** SWF keeper → 301 twins → **Waves 6–16**. Prefer the API. After Wave 8 CIC paste, 301 `/china-investment-corporation-cic/`. `/cpp-investments-explained/` is already on C$793.3bn — 301 the short slug now. After Wave 15, 301 `/asset-owner-events-conferences-2026/`, `/turkey-wealth-fund/`, and `/what-is-liability-driven-investing/`. After Wave 16, 301 the PFZW/PGGM twins. **Do not mint** `/psp-investments/` or `/korea-investment-corporation-kic/` (Wave 3 404s).
