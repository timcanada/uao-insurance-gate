...
The agent cannot log into Ghost from this repo. This is the publisher checklist.
...
3. Paste the Wave 1 set into Ghost in the order in `publish/wave-1/INDEX.md`.
4. 301 the twin explainers in `04-page-architecture.md`.
